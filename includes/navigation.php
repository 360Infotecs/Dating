            ...
            <div class="card-body">
                <form>
                    <div class="form-group">
                        <label for="exampleInputEmail1" class="lblcolor">I am</label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="lblcolor">I am</label>
                        <input class="form-control" type="password" placeholder="Password">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="lblcolor">Password</label>
                        <input class="form-control" type="password" placeholder="Password">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="lblcolor">Password</label>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="messagesDropdown">
                    ...
                    <a class="dropdown-item" href="#">
                        ...
                        <span class="small float-right text-muted">11:21 AM</span>
                        <div class="dropdown-message small">I have sent the final files over to you for review. When youre able to sign off of them let me know and we can discuss distribution.</div>
                    </a>
                    <div class="dropdown-divider"></div>
